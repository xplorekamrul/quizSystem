...
export default function StudentQuiz() {
  ...
  }, [isQuizStarted, isQuizCompleted, currentQuestionIndex])
      ...
      <div className="container mx-auto p-6 max-w-2xl space-y-6">
        <Card>
          ...
          <CardContent className="text-center space-y-4">
            ...
            <div className="text-sm text-gray-600">Tab switches detected: {tabSwitchCount}</div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  <h4 className="font-semibold text-yellow-800 mb-2">Security Requirements:</h4>
                  <ul className="space-y-1 text-yellow-700">
                    <li>• Quiz must be taken in fullscreen mode</li>
                    <li>• Each question has a 1-minute timer</li>
                    <li>• Tab switching will result in warnings (3 strikes = termination)</li>
    ...
    <div className="container mx-auto p-6 max-w-2xl">
      ...
      <div className="mb-6 space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            {tabSwitchCount > 0 && <div className="text-red-600 text-sm">Warnings: {tabSwitchCount}/3</div>}
          </div>
        </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="text-base leading-relaxed">{currentQuestion.text}</div>
